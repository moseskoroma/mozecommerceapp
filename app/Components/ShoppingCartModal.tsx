      ...
      <SheetContent className=" sm:max-w-lg w-[90vw]">
        ...
        <div className=" h-full flex flex-col justify-between">
          ...
          <div className=" border-t border-gray-200 px-4 py-6 sm:px-6">
               ...
               <p className=" mt-0.5 text-sm text-gray-500">Shipping and taxes are calculated.</p>
          </div>
          <div className=" mb-6">
           <Button onClick={handleCheckoutClick} className=" w-full">Checkout</Button>
          </div>
          <div className=" mb-6 flex justify-center text-sm text-gray-500">
               <p>OR <button onClick={() => handleCartClick()} className=" font-medium text-primary hover:text-primary">Continue Shopping</button></p>
          </div>
        </div>
      </SheetContent>
    </Sheet>
